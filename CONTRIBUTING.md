# Contributing to the Kiota multipart serialization for Go

The Kiota multipart serialization for Go is available for all manner of contribution. There are a couple of different recommended paths to get contributions into the released version of this SDK.
...
The changelog is generated automatically as part of the release process. Do not update the changelog in pull requests.
