...
func TestItWritesAStructuredObject(t *testing.T) {
	...
	createdDateTimeValue, err := time.Parse(time.RFC3339, "-999999999-01-01T00:00:00+18:00")
	assert.Nil(t, err)
	...
	multipartBody.AddOrReplacePart("binaryValue", "application/octet-stream", binaryValue)
	serializer.WriteObjectValue("", multipartBody)
	result, err := serializer.GetSerializedContent()
	assert.Nil(t, err)
	assert.Equal(t, "--"+multipartBody.GetBoundary()+"\r\nContent-Type: application/octet-stream\r\nContent-Disposition: form-data; name=\"image\"\r\n\r\n"+string(binaryValue[:])+"\r\n--"+multipartBody.GetBoundary()+"\r\nContent-Type: application/json\r\nContent-Disposition: form-data; name=\"testEntity\"\r\n\r\n{\"id\":\"48d31887-5fad-4d73-a9f5-3c356e68a038\",\"birthDay\":\"2017-09-04\",\"workDuration\":\"P1M\",\"startWorkTime\":\"08:00:00\",\"mobilePhone\":null,\"jobTitle\":\"Author\",\"createdDateTime\":\"-999999999-01-01T00:00:00+18:00\",\"otherPhones\":[[\"device1\",\"device2\"]],\"accountEnabled\":false}\r\n--"+multipartBody.GetBoundary()+"--", string(result[:]))
}
